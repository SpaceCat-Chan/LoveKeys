...
function love.load()
	...
	assert(LoveKeys.r.AliasTo[1] == "test", "re-alias consistancy is not preserved")
	LoveKeys.Alias({}, "test")
	assert(LoveKeys.r.AliasTo[1] == nil, "re-alias consistancy is not preserved")
	assert(LoveKeys.r.AliasTo[2] == "test2", "re-alias consistancy is not preserved")
